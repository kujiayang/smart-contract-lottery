...
contract DeployRaffle is Script {
    function run() external returns (Raffle, HelperConfig) {
        ...
        // importing NetworkConfig struct from HelperConfig, get these values from activeNetworkConfig
        (
            uint256 entranceFee,
            uint256 interval,
        ...
        // add raffle contract to list of consumers in VRF subscription
